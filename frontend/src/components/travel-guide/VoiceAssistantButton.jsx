...
const AGENT_ID = 'agent_0001kqad7r09f7j8yx9vw9b67k4t'
...
function VoiceAssistantInner({ circuitName }) {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-center gap-2.5">
        {status === 'connected' && (
          <div
            style={{
