    ...
    <div className="bg-page-gradient min-h-svh">
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 720, margin: '0 auto', padding: '80px 24px 80px' }}>
        ...
        <Section title="7. Privacy">
          <p>Your use of the Service is subject to our <Link to="/privacy" style={{ color: 'rgba(100,168,200,0.6)', textDecoration: 'none' }}>Privacy Policy</Link>, which is incorporated into these Terms by reference. By using the Service, you consent to the data practices described therein.</p>
        </Section>
        ...
        <Section title="13. Contact">
          <p>For any questions regarding these Terms, contact us at <a href="mailto:legal@laptheworld.com" style={{ color: 'rgba(100,168,200,0.6)', textDecoration: 'none' }}>legal@laptheworld.com</a>.</p>
        </Section>

        <div style={{ marginTop: 40, paddingTop: 24, borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: 20, flexWrap: 'wrap' }}>
          <Link to="/privacy" style={{ fontSize: 12, color: 'rgba(100,168,200,0.5)', textDecoration: 'none' }}
            onMouseEnter={e => { e.currentTarget.style.color = 'rgba(100,168,200,0.8)' }}
            onMouseLeave={e => { e.currentTarget.style.color = 'rgba(100,168,200,0.5)' }}
          >Privacy Policy →</Link>
        </div>
